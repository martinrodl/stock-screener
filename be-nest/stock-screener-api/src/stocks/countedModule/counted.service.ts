...
import { MetricsRepository } from '../fmpModule/repositories/metrics.repository';
import { StatementsRepository } from '../fmpModule/repositories/statements.repository';
...
export class CountedService {
  ...
  private async fetchAndCalculateStockValues(
    ...
    // const stockId = stock._id; // Keep it as ObjectId
